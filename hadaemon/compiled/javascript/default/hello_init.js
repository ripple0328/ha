$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-clock-clock"] = new baseclock("default-clock-clock", "http://192.168.199.173:80", "default", {'widget_type': 'baseclock', 'fields': {'date': '', 'time': ''}, 'static_css': {'date_style': 'color: #fff;', 'time_style': 'color: #aa00ff;', 'widget_style': 'background-color: #444;'}, 'static_icons': [], 'icons': [], 'css': {}, 'entity': 'clock.clock', 'title_is_friendly_name': 1})
    
        widgets["default-weather-weather"] = new baseweather("default-weather-weather", "http://192.168.199.173:80", "default", {'widget_type': 'baseweather', 'fields': {'title': '', 'unit': '', 'dark_sky_temperature': '', 'dark_sky_humidity': '', 'dark_sky_precip_probability': '', 'dark_sky_precip_intensity': '', 'dark_sky_wind_speed': '', 'dark_sky_pressure': '', 'dark_sky_wind_bearing': '', 'dark_sky_apparent_temperature': '', 'dark_sky_icon': ''}, 'css': {}, 'static_css': {'title_style': 'color: #00aaff;', 'unit_style': 'color: #ffaa00;', 'main_style': 'color: #ffaa00;', 'sub_style': 'color: #00aaff;', 'widget_style': 'background-color: #444;'}, 'icons': [], 'static_icons': [], 'entity': 'weather.weather', 'title_is_friendly_name': 1})
    
        widgets["default-sensor-illumination-34ce00fa599b"] = new basedisplay("default-sensor-illumination-34ce00fa599b", "http://192.168.199.173:80", "default", {'widget_type': 'basedisplay', 'entity': 'sensor.illumination_34ce00fa599b', 'sub_entity': '', 'fields': {'title': '', 'title2': '', 'value': '', 'unit': '', 'state_text': ''}, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'unit_style': '', 'value_style': '', 'state_text_style': '', 'widget_style': 'background-color: #444;'}, 'css': {'value_style': 'color: #00aaff;font-size: 250%;', 'text_style': 'color: #fff;font-size: 100%;', 'unit_style': 'color: #00aaff;font-size: 100%;'}, 'icons': [], 'static_icons': [], 'title_is_friendly_name': 1})
    
        widgets["default-binary-sensor-door-window-sensor-158d000120c826"] = new baseswitch("default-binary-sensor-door-window-sensor-158d000120c826", "http://192.168.199.173:80", "default", {'widget_type': 'baseswitch', 'entity': 'binary_sensor.door_window_sensor_158d000120c826', 'state_active': 'on', 'state_inactive': 'off', 'enable': 0, 'fields': {'title': '', 'title2': '', 'icon': '', 'icon_style': '', 'state_text': ''}, 'icons': {'icon_on': 'fa-bullseye', 'icon_off': 'fa-minus'}, 'static_icons': [], 'css': {'icon_style_active': 'color: #ff0055;', 'icon_style_inactive': 'color: #888;'}, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'state_text_style': 'color: #fff;', 'widget_style': 'background-color: #444;'}, 'title_is_friendly_name': 1})
    
        widgets["default-binary-sensor-motion-sensor-158d00012254b0"] = new baseswitch("default-binary-sensor-motion-sensor-158d00012254b0", "http://192.168.199.173:80", "default", {'widget_type': 'baseswitch', 'entity': 'binary_sensor.motion_sensor_158d00012254b0', 'state_active': 'on', 'state_inactive': 'off', 'enable': 0, 'fields': {'title': '', 'title2': '', 'icon': '', 'icon_style': '', 'state_text': ''}, 'icons': {'icon_on': 'fa-bullseye', 'icon_off': 'fa-minus'}, 'static_icons': [], 'css': {'icon_style_active': 'color: #ff0055;', 'icon_style_inactive': 'color: #888;'}, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'state_text_style': 'color: #fff;', 'widget_style': 'background-color: #444;'}, 'title_is_friendly_name': 1})
    
        widgets["default-binary-sensor-switch-158d000182fa7a"] = new baseswitch("default-binary-sensor-switch-158d000182fa7a", "http://192.168.199.173:80", "default", {'widget_type': 'baseswitch', 'entity': 'binary_sensor.switch_158d000182fa7a', 'state_active': 'on', 'state_inactive': 'off', 'enable': 0, 'fields': {'title': '', 'title2': '', 'icon': '', 'icon_style': '', 'state_text': ''}, 'icons': {'icon_on': 'fa-bullseye', 'icon_off': 'fa-minus'}, 'static_icons': [], 'css': {'icon_style_active': 'color: #ff0055;', 'icon_style_inactive': 'color: #888;'}, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'state_text_style': 'color: #fff;', 'widget_style': 'background-color: #444;'}, 'title_is_friendly_name': 1})
    
        widgets["default-light-gateway-light-34ce00fa599b"] = new baselight("default-light-gateway-light-34ce00fa599b", "http://192.168.199.173:80", "default", {'widget_type': 'baselight', 'entity': 'light.gateway_light_34ce00fa599b', 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'light.gateway_light_34ce00fa599b'}, 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'light.gateway_light_34ce00fa599b'}, 'fields': {'title': '', 'title2': '', 'icon': '', 'units': '%', 'level': '', 'state_text': '', 'icon_style': ''}, 'icons': {'icon_on': 'fa-circle', 'icon_off': 'fa-circle-thin'}, 'static_icons': {'icon_up': 'fa-plus', 'icon_down': 'fa-minus'}, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'state_text_style': 'color: #fff;', 'level_style': 'color: #fff;', 'unit_style': 'color: #fff;', 'level_up_style': 'color: #888;', 'level_down_style': 'color: #888;', 'widget_style': 'background-color: #444;'}, 'css': {'icon_style_active': 'color: #aaff00;', 'icon_style_inactive': 'color: #888;'}, 'title_is_friendly_name': 1})
    
        widgets["default-light-yeelight-rgb-34ce0084e2f4"] = new baselight("default-light-yeelight-rgb-34ce0084e2f4", "http://192.168.199.173:80", "default", {'widget_type': 'baselight', 'entity': 'light.yeelight_rgb_34ce0084e2f4', 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'light.yeelight_rgb_34ce0084e2f4'}, 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'light.yeelight_rgb_34ce0084e2f4'}, 'fields': {'title': '', 'title2': '', 'icon': '', 'units': '%', 'level': '', 'state_text': '', 'icon_style': ''}, 'icons': {'icon_on': 'fa-circle', 'icon_off': 'fa-circle-thin'}, 'static_icons': {'icon_up': 'fa-plus', 'icon_down': 'fa-minus'}, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'state_text_style': 'color: #fff;', 'level_style': 'color: #fff;', 'unit_style': 'color: #fff;', 'level_up_style': 'color: #888;', 'level_down_style': 'color: #888;', 'widget_style': 'background-color: #444;'}, 'css': {'icon_style_active': 'color: #aaff00;', 'icon_style_inactive': 'color: #888;'}, 'title_is_friendly_name': 1})
    
        widgets["default-switch-plug-158d0001dc3b13"] = new baseswitch("default-switch-plug-158d0001dc3b13", "http://192.168.199.173:80", "default", {'widget_type': 'baseswitch', 'entity': 'switch.plug_158d0001dc3b13', 'state_active': 'on', 'state_inactive': 'off', 'enable': 1, 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'switch.plug_158d0001dc3b13'}, 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'switch.plug_158d0001dc3b13'}, 'fields': {'title': '', 'title2': '', 'icon': '', 'icon_style': '', 'state_text': ''}, 'icons': {'icon_on': 'fa-circle', 'icon_off': 'fa-circle-thin'}, 'static_icons': [], 'css': {'icon_style_active': 'color: #aaff00;', 'icon_style_inactive': 'color: #888;'}, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'state_text_style': 'color: #fff;', 'widget_style': 'background-color: #444;'}, 'title_is_friendly_name': 1})
